...
export const fetchTweets: QueryFunction<
  TweetResponse,
...
const fromResponseToTweet =
  (loggedInUserId?: string) =>
  (response: TweetServerResponse): Tweet => {
    ...
    return {
      ...
      author: tweet_author,
      isFavorited:
        favorited_users?.findIndex((u) => u.id === loggedInUserId) > -1,
...
export const fromTweetRequestToTweet = (
  rawTweet: AddTweetRequestBody,
  user: Profile
) => {
